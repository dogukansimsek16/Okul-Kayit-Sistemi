...
namespace DataAccessLayer
{
    public class DALOgrenci
    {
        public static int OgrenciEkle(EntityOgrenci parametre)
        {
            ...
            if (komut1.Connection.State != ConnectionState.Open) // Eğer bağlantım kapalıysa
            {
                komut1.Connection.Open();
            }
            komut1.Parameters.AddWithValue("@p1", parametre.AD);
            komut1.Parameters.AddWithValue("@p2", parametre.SOYAD);
            komut1.Parameters.AddWithValue("@p3", parametre.NUMARA);  // Değer ataması
        ...
        public static List<EntityOgrenci> OgrenciListesi()
        {
            ...
            if (komut2.Connection.State != ConnectionState.Open) // Eğer bağlantım kapalıysa
            {
        ...
        public static bool OgrenciSil(int parametre)
        {
            ...
            if (komut3.Connection.State != ConnectionState.Open) // Eğer bağlantım kapalıysa
            {
        ...
        public static List<EntityOgrenci> OgrenciDetay(int id)
        {
            ...
            if (komut4.Connection.State != ConnectionState.Open) // Eğer bağlantım kapalıysa
            {
        ...
        public static bool OgrenciGuncelle(EntityOgrenci deger)
        {
            ...
            if (komut5.Connection.State != ConnectionState.Open) // Eğer bağlantım kapalıysa
            {
